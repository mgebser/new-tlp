...
\verb"new_tlp.cls" as early as possible in the creation of their files.
...
Authors are urged to use \verb"new_tlp.cls" from the beginning of their document
...
single file \verb"new_tlpcls.ltx" in the directory
%
\begin{verbatim}
  pub/texarchive/journals/latex/new_tlp-cls
\end{verbatim}
%
The \verb"readme.txt" (which is the same directory) tells you how to
unpack the file \verb"new_tlpcls.ltx".
...
First, copy the file \verb"new_tlp.cls" (and download \verb"acmtrans.bst" if you 
...
by \verb"new_tlp" in the \verb"\documentclass" command at the beginning of your 
document: that is,
%
\begin{verbatim}
...
it can be processed only with \verb"new_tlp.cls".
...
%
\verb"  % sample.tex"\\[2pt]
\verb"  \documentclass{new_tlp}"\\[2pt]
...
journal. It was generated from \verb"new_tlp2egui.bib" and produces the references at the 
end of this guide.
%
\begin{verbatim}
...
\mbox{}\vfill\eject
\section{Special commands in {\mdseries\texttt{new\underline{~}tlp.cls}}}
...
\verb"new_tlp.cls" to typeset in the production typeface -- Monotype Times.
e.g.
%
\begin{verbatim}
  \documentclass[prodtf]{new_tlp}
\end{verbatim}
...
The add on package \verb"new_TLPland" provides macros for landscape figures and
tables. See the \verb"new_TLPland" guide for further information.
